      ...
      <DialogContent className="flex max-h-[85vh] flex-col overflow-hidden sm:max-w-xl">
        ...
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-2">
          ...
          <div className="space-y-2">
            ...
            />
            <div className="text-muted-foreground text-xs">格式：provider1:id1;provider2:id2</div>
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input value={formValues.music} onChange={(e) => setField('music', e.target.value)} />
          </div>
          <div className="space-y-2">
            <div className="text-sm">剧本</div>
            <Input value={formValues.script} onChange={(e) => setField('script', e.target.value)} />
          </div>
          <div className="space-y-2">
          ...
          <div className="flex items-center justify-between rounded-md">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => setFormValues((prev) => ({ ...prev, nsfw: checked }))}
