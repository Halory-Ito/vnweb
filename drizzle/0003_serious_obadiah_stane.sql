CREATE TABLE `game_memory` (
	...
	`createdAt` text DEFAULT 'Sun, 08 Mar 2026 02:20:10 GMT',
	`updatedAt` text DEFAULT 'Sun, 08 Mar 2026 02:20:10 GMT'
);
...
--> statement-breakpoint
INSERT INTO `__new_character`("id", "gameId", "name", "nameCn", "gender", "age", "description", "birthday", "createdAt", "updatedAt") SELECT "id", "gameId", "name", "nameCn", "gender", "age", "description", "birthday", "createdAt", "updatedAt" FROM `character`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_third_party_account`("id", "provider", "accountId", "accessToken", "refreshToken", "expiresAt", "createdAt", "updatedAt") SELECT "id", "provider", "accountId", "accessToken", "refreshToken", "expiresAt", "createdAt", "updatedAt" FROM `third_party_account`;--> statement-breakpoint
